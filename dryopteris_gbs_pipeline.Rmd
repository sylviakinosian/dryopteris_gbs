...
plot_q_per_chain <- function(kqlist, xlabel, ...){
	cols <- c('#F38020','#F5C527','#D62227','#71449A','#8FBA3E','#40B8D8')	
...
# n = #SNPs * sample size
# i-c-e clade
igk2<-matrix(scan("ice_gpk2.txt", n=3964*8,sep=","), nrow=8,ncol=3964,byrow=T)
igk3<-matrix(scan("ice_gpk3.txt", n=3964*8,sep=","), nrow=8,ncol=3964,byrow=T)
igk4<-matrix(scan("ice_gpk4.txt", n=3964*8,sep=","), nrow=8,ncol=3964,byrow=T)
igk5<-matrix(scan("ice_gpk5.txt", n=3964*8,sep=","), nrow=8,ncol=3964,byrow=T)

# l-g-c clade
lgk2<-matrix(scan("lgc_gpk2.txt", n=4419*8,sep=","), nrow=8,ncol=4419,byrow=T)
lgk3<-matrix(scan("lgc_gpk3.txt", n=4419*8,sep=","), nrow=8,ncol=4419,byrow=T)
lgk4<-matrix(scan("lgc_gpk4.txt", n=4419*8,sep=","), nrow=8,ncol=4419,byrow=T)
lgk5<-matrix(scan("lgc_gpk5.txt", n=4419*8,sep=","), nrow=8,ncol=4419,byrow=T)

# average all four Ks
g.avg1<-(igk2+igk3+igk4+igk5)/4
...
cols1 <- c(rep("black", 2), "blue", "black", rep("red",4))

# colors for the ludoviciana-goldiana-celsa clade
cols2 <- c(rep("black", 3), "blue", rep("red", 4))

# plot ICE clade
plot(g.pca1$x[,1], g.pca2$x[,2], col = cols1, xlab="PCA1",ylab="PCA2", cex.lab=1.3, cex.axis=1.6, main = "PCA of Dryopteris intermedia-expansa-campyloptera", pch=19)

# add a legend
legend(49, 30, legend=c("D. intermedia", "D. expansa", "D. campyloptera"), col=c("black", "blue", "red"), pch=19, cex=0.9)
...
# add a legend
legend(49, 30, legend=c("D. goldiana", "D. ludoviciana", "D. celsa"), col=c("black", "blue", "red"), pch=19, cex=0.9)
